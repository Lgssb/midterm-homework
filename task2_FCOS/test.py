...
if __name__=="__main__":
    ...
    #eval_dataset=VOCDataset("/root/VOC2007",resize_size=[800,1024],split='test')
    eval_dataset=VOCDataset("/root/VOC2007",resize_size=[800,1024],split='val')
    ...
    model.load_state_dict(torch.load("/root/FCOS.Pytorch-master/FCOS.Pytorch-master.pth",map_location=torch.device('cpu')))
